...
NDiplomacy = {
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.3,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 3.05,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
...
NCountry = {
	...
	CIVIL_WAR_INVOLVEMENT_MIN_TENSION = 0.3,		-- base value of world tension to involve other sides to the civil war
	UNCAPITULATE_LEVEL = 0.1,                       -- if we reclaim this much and our capital we reset capitulate status
	BASE_SURRENDER_LIMIT = 0.4,						-- Base level of occupation required for country surrender
...
NAI = {
	...
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 0.4,-- How much the AI takes global tension into account when considering faction actions
